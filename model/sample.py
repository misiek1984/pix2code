...
if __name__ == "__main__":
    ...
    if len(argv) < 4:
        ...
        print("sample.py <trained weights path> <trained model name> <input image> <output path> <search method (default: greedy)> <prefix (default: )>")
        exit(0)
    else:
        ...
        prefix = "" if len(argv) < 6 else argv[5]
    ...
    with open("{}/{}{}.gui".format(output_path, prefix, file_name), 'w') as out_f:
